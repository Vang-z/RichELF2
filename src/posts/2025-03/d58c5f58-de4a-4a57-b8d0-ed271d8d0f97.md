---
icon: mug-hot
title: C/C++实现字符串的UTF-8/ANSI/Unicode的相互转换
date: 2025-03-11
category:
  - 编码
tag:
...
prev: false
next: false
excerpt: "使用<a>C/C++</a>实现字符串的<a>UTF-8/ANSI/Unicode</a>的相互转换。"
---


### 摘要

本文提供了一种使用<a>C/C++</a>在<a>Windows</a>平台对字符串进行<a>UTF-8/ANSI/Unicode</a>相互转换的方法:
